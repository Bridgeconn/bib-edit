...
{".label-folder-location": "label-folder-location"}, {"#label-bible-name": "label-bible-name"}, {"#label-book-chapter": "label-book-chapter"}, {".btn-save":'btn-save'},{".btn-import":'btn-import'},{"#exportUsfm":'btn-export'},{"#btn-ok":'btn-ok'},{"#btnfindReplace":'btn-replace'},{"#btn-save-changes":'btn-save-changes'},{"#tbl-header-name":'tbl-header-name'},{"#tbl-header-action":'tbl-header-action'},{"#modal-title-setting":'modal-title-setting'},{"#label-find-replace":'label-find-replace'},{"#label-current-chapter":'label-current-chapter'},{"#label-current-book":'label-current-book'},{"#label-find":'label-find'},{"#label-replace-with":'label-replace-with'},{"#export-heading":'tooltip-export-usfm'},{"#replace-information":'label-replaced-information'},{"#replace-cancel":'btn-cancel'},{"#modal-title-about":'modal-title-about'},{"#overviewtab":'label-overview-tab'},{"#licensetab":'label-license-tab'},{"#booksTab":'label-books-tab'},{"#chapterTab":'label-chapter-tab'},{"#allBooksBtn":'btn-all'},{"#otBooksBtn":'btn-ot'}, {"#ntBooksBtn":'btn-nt'},{"#app-name":'app-name-Autographa-Lite'},{"#label-hosted-url":'label-hosted-url'},{".stage":'label-stage'}  ]
